        ...
        <div class="contenedor-anuncios">
            <div class="anuncio">
                <picture>
                    ...
                    <img lazy="loading" src="build/img/anuncio1.jpg" alt="anuncio">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa de lujo en el lago</h3>
                    <p>Casa en el lago con exclente vista, acabados de lujo a exclente precio</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img lazy="loading" src="build/img/anuncio2.jpg" alt="anuncio">
                </picture>
                <div class="contenido-anuncio">
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img lazy="loading" src="build/img/anuncio3.jpg" alt="anuncio">
                </picture>
                <div class="contenido-anuncio">
